...
import { User, X, UserCircle, Search } from "lucide-react"
        ...
        <div className="navbar bg-newBlack shadow-lg border border-stone-800 px-6  py-3  flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <button
              ...
              className="btn md:btn-md btn-sm  btn-circle bg-gradient-to-br from-yellow-300 via-amber-400 to-yellow shadow-lg hover:scale-105 hover:shadow-amber-400/50 transition-transform duration-300 border-0 ring-2 ring-yellow"
            >
                ...
                ${activeTab === "user" ? "bg-white text-black shadow-md" : "text-black/80 hover:bg-white/30"}`}
                  ...
                  >
                    <div className="flex items-center justify-center gap-2 text-sm">
                      <img src={Profile || "/placeholder.svg"} alt="user" width={22} height={22} />
                      User
                    </div>
                  </button>
                  {user.role === "seller" && (
              ...
              <ul className="menu w-full bg-gradient-to-r from-[#0F0F0F] via-[#1A1A1A] to-[#2A2A2A]  text-white px-5 pb-10 rounded-box gap-2">
                {activeTab === "user" ? (
                  <>
                    <li className="rounded-xl bg-gradient-to-r from-[#2A2A2A] via-[#1A1A1A] to-[#0F0F0F] hover:bg-blue-400/60 hover:scale-[1.01] transition-all">
                      <Link to="/user/" className="flex gap-3 items-center p-2">
                        <div className="bg-primaryYellow p-1 rounded-md">
                          <img src={Home || "/placeholder.svg"} alt="Home" width={20} />
                        </div>
                        <span className="font-medium">Home</span>
                      </Link>
                    </li>
                    <li className="rounded-xl bg-gradient-to-r from-[#2A2A2A] via-[#1A1A1A] to-[#0F0F0F] hover:bg-blue-400/60 hover:scale-[1.01] transition-all">
                      <Link to="/user/verified-user" className="flex gap-3 items-center p-2">
                        <div className="bg-primaryYellow p-1 rounded-md">
                          <img src={Home || "/placeholder.svg"} alt="Home" width={20} />
                        </div>
                    ...
                    {/* <li className="rounded-xl bg-gradient-to-r from-[#2A2A2A] via-[#1A1A1A] to-[#0F0F0F] hover:bg-blue-400/60 hover:scale-[1.01] transition-all">
                      <Link to="/user/giveaway" className="flex gap-3 items-center p-2">
                        <div className="bg-primaryYellow p-1 rounded-md">
                          <img src={Home || "/placeholder.svg"} alt="Giveaway" width={20} />
                        </div>
                    ...
                    >
                      <div className="flex gap-3 items-center p-2">
                        <div className="bg-primaryYellow p-1 rounded-md">
                          <img src={Logout || "/placeholder.svg"} alt="Logout" width={22} />
                        </div>
                  ...
                  <>
                    {/* <li className="rounded-xl bg-gradient-to-r from-[#2A2A2A] via-[#1A1A1A] to-[#0F0F0F] hover:bg-blue-400/60 hover:scale-[1.01] transition-all">
                      <Link to="/seller/allshows" className="flex gap-3 items-center p-2">
                        <div className="bg-primaryYellow p-1 rounded-md">
                          <img src={Reels || "/placeholder.svg"} alt="Create Shows" width={20} />
                        </div>
                        <span className="font-medium">Create Shows</span>
                      </Link>
                    </li> */}
                    <li className="rounded-xl bg-gradient-to-r from-[#2A2A2A] via-[#1A1A1A] to-[#0F0F0F] hover:bg-blue-400/60 hover:scale-[1.01] transition-all">
                      <Link to="/seller/productlisting" className="flex gap-3 items-center p-2">
                        <div className="bg-primaryYellow p-1 rounded-md">
                          <img src={Inventory || "/placeholder.svg"} alt="Listing" width={20} />
                        </div>
                        <span className="font-medium">Products</span>
                      </Link>
                    </li>
                    {/* <li className="rounded-xl bg-gradient-to-r from-[#2A2A2A] via-[#1A1A1A] to-[#0F0F0F] hover:bg-blue-400/60 hover:scale-[1.01] transition-all">
                      <Link to="/seller/myprofile" className="flex gap-3 items-center p-2">
                        <div className="bg-primaryYellow p-1 rounded-md">
                          <img src={Profile || "/placeholder.svg"} alt="My Profile" width={20} />
                        </div>
                     ...
                     <li className="rounded-xl bg-gradient-to-r from-[#2A2A2A] via-[#1A1A1A] to-[#0F0F0F] hover:bg-blue-400/60 hover:scale-[1.01] transition-all">
                      <Link to="/seller/viewvideo" className="flex gap-3 items-center p-2">
                        <div className="bg-primaryYellow p-1 rounded-md">
                          <img src={Reels || "/placeholder.svg"} alt="My Profile" width={20} />
                        </div>
