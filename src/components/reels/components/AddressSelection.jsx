...
export const AddressSelection = ({ selectedAddress, onSelectAddress, onNext, onBack }) => {
  ...
  if (!userData?._id) {
    return (
      <div className="p-7 bg-ghost text-error text-center">
        ...
        <div className="space-y-4">
          {isLoading ? (
            ...
            addresses.map((addressItem) => (
              <div
                key={addressItem._id}
                className={`p-4 rounded-xl bg-stone-700 hover:shadow-md transition cursor-pointer border-2 ${selectedAddress?._id === addressItem._id ? "border-yellow-400" : "border-stone-600"
                  }`}
