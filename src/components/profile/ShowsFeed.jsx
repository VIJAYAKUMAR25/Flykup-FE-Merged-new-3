    ...
    if (shows.length === 0) {
        ...
        <div className="hero-content text-center">
          <div className="max-w-md">
            <h1 className="text-2xl font-bold text-base-content">No Shows Available</h1>
            <p className="py-6">Currently there are no shows available. Please check back later.</p>
          </div>
        </div>
      </div>
        );
        ...
        <div className="p-2">
            ...
            <div className="flex justify-center mb-6 bg-newWhite rounded-lg p-1 shadow-sm mx-auto max-w-md">
                <button
                    ...
                    className={`px-4 py-2 font-medium text-sm md:text-base rounded-lg transition-all duration-300 flex items-center justify-center flex-1 ${activeTab === "all"
                ...
                <button
                    ...
                    className={`px-4 py-2 font-medium text-sm md:text-base rounded-lg transition-all duration-300 flex items-center justify-center flex-1 ${activeTab === "live"
                ...
                <button
                    ...
                    className={`px-4 py-2 font-medium text-sm md:text-base rounded-lg transition-all duration-300 flex items-center justify-center flex-1 ${activeTab === "upcoming"
              ...
              >
                  ...
                  <figure className="relative">
                      ...
                      <div className="w-full h-52 overflow-hidden">
                          <img
                              src={signedUrls[show._id] || "/placeholder.svg"}
                              alt={show.title}
                              className="w-full h-full object-cover transition-transform duration-300 hover:scale-105"
                              onError={(e) => {
                                  e.target.onerror = "/placeholder.svg";
                      ...
                      <div className="absolute top-3 left-3 z-20">
                          {show.showStatus === "live" ? (
                              ...
                              <motion.div
                                  className="bg-gray-800 text-white text-xs px-3 py-1.5 rounded-full font-bold shadow-md flex items-center"
                              >
                      ...
                      <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent px-4 py-3">
                          <div className="flex items-center justify-between text-white">
                              <div className="flex items-center">
                                  ...
                                  <span className="text-xs font-medium">{formatDate(show.date)}</span>
                              </div>
                              <div className="flex items-center">
                                  <svg
                                      className="w-4 h-4 mr-1.5"
                                  ...
                                  <span className="text-xs font-medium">{show.time}</span>
                              </div>
                          </div>
                      </div>
                  </figure>
                  ...
                  <div className="card-body p-4">
                      ...
                      <div
                          ...
                          onClick={() => handleProfileView(show.sellerId?.userInfo?.userName)}
                      >
                          <div className="avatar">
                              <div className="w-8 h-8 rounded-full ring ring-amber-400 ring-offset-1">
                                  <img
                                      src={`https://ui-avatars.com/api/?name=${encodeURIComponent(
                                          show.sellerId?.userInfo?.userName || "User"
                          ...
                          <div>
                              <h3 className="text-sm font-semibold text-gray-800 truncate">
                                  {show.sellerId?.companyName || "Company"}
                              </h3>
