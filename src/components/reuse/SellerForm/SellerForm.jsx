...
const SellerFormNew = () => {
  ...
  const proceedToRegistration = () => {
    if (selectedType === "brand") {
      navigate("/user/brand-seller-registration");
    } else {
      navigate("/user/social-seller-registration");
    }
  };

  return (
    <div className="min-h-screen w-full bg-newYellow">
                ...
                <div className="text-center space-y-3">
                  ...
                  <div className="bg-red-50 rounded-lg p-4 border border-red-100">
                    <p className="text-gray-600">
                      {userData?.sellerInfo?.rejectedReason ||
