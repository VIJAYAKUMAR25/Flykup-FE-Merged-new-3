...
const UserSideSellerProfile = () => {
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-newWhite">
        ...
        <p className="text-lg font-medium text-gray-700">Seller profile is loading...</p>
      </div>
    );
  }
  ...
  const dummySeller = {
    displayName: sellerData?.companyName,
    username: sellerData?.userInfo?.userName,
    ...
    shop: [
      {
        ...
        price: "₹5,499",
        size: "Free Size",
        image: "https://picsum.photos/id/1061/300/300",
      },
      {
        id: 2,
      ...
      {
        id: 4,
        name: "Palm Leaf Manuscript Notebook",
        price: "₹799",
        size: "A5",
    ...
    shows: [
      {
        ...
        status: "LIVE",
        viewers: "2.5K",
        image: "https://picsum.photos/id/1069/300/375",
      },
      {
        id: 2,
        status: "Upcoming",
        time: "Tomorrow, 6 PM",
        image: "https://picsum.photos/id/1070/300/375",
      },
      {
        id: 3,
        status: "Ended",
        views: "7.2K",
        image: "https://picsum.photos/id/1071/300/375",
      },
    ],
    orders: [
      {
        ...
        status: "Delivered on 10 Mar",
        productImage: "https://picsum.photos/id/1072/100/100",
        rating: 5,
        price: "₹2,999",
      },
      {
        id: 2,
        name: "Handmade Clay Golu Dolls",
        status: "Shipped • Arriving Tomorrow",
        productImage: "https://picsum.photos/id/1073/100/100",
        price: "₹1,499",
      },
      {
        id: 3,
        name: "Brass Veena Miniature",
        status: "Processing",
        productImage: "https://picsum.photos/id/1074/100/100",
        price: "₹2,199",
      },
    ],
  };
        ...
        return (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {dummySeller.shop.map((item) => (
              <div
                key={item.id}
                className="bg-newWhite hover:shadow-md transition-all duration-300 rounded-xl overflow-hidden border border-gray-100"
              >
                ...
                <div className="p-4">
                  ...
                  <p className="text-newBlack font-semibold text-base">
                    {item.price}
                  </p>
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-newBlack/70 via-newBlack/20 to-transparent flex flex-col justify-end p-4">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className="text-newWhite text-sm font-medium">
                      {video.views}
                    </span>
                  </div>
                  <h3 className="text-newWhite font-semibold text-base line-clamp-1">
                    {video.title}
                  </h3>
                  <p className="text-newWhite/80 text-sm mt-1 line-clamp-1">
                    {video.hashtags}
                  </p>
            ...
            {dummySeller.shows.map((show) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-newBlack/70 via-newBlack/20 to-transparent flex flex-col justify-between p-4">
                  <div
                    className={`self-start px-3 py-1 rounded-full text-sm font-medium ${show.status === "LIVE"
                      ? "bg-rose-500 text-newWhite animate-pulse"
                      : show.status === "Upcoming"
                        ? "bg-amber-300 text-newBlack"
        ...
        return (
          <div className="space-y-4">
            {dummySeller.orders.map((order) => (
              <div
                key={order.id}
                className="bg-newWhite rounded-xl shadow-sm overflow-hidden border border-gray-100"
              >
                <div className="p-4 flex items-center">
                  ...
                  <div className="ml-4 flex-1">
                    <div className="flex justify-between flex-wrap">
                      ...
                      <span className="text-newBlack font-semibold text-base">
                        {order.price}
                      </span>
                    </div>
                    <p
                      className={`text-sm mt-1 ${order.status.includes("Delivered")
                        ? "text-emerald-600"
                ...
                <div className="bg-gray-50 p-3 flex items-center justify-between text-sm">
                  <button className="text-newBlack font-medium">
                    View Details
                  </button>
            ...
            <div className="flex items-center gap-2 bg-white py-1.5 px-3 rounded-full shadow-sm border border-amber-200">
              ...
              <div className="flex flex-col items-center">
                <h1 className="text-gray-800 font-semibold text-lg">
                  {sellerData?.companyName || "Fashion Store"}
                </h1>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between">
                <div className="text-center sm:text-left">
                  ...
                  <p className="text-gray-600 text-sm">
                    @{dummySeller.username}
                  </p>
                  <div className="flex gap-4 mt-2 justify-center sm:justify-start">
                    <p className="text-newBlack text-sm">
                      <span className="font-bold">{dummySeller.following}</span>{" "}
                      Following
                    </p>
                    <p className="text-newBlack text-sm">
                      <span className="font-bold">{dummySeller.followers}</span>{" "}
                      Followers
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-2 mt-4 sm:mt-0 w-full sm:w-auto justify-center sm:justify-end">
                  ...
                  <button
                    className={`py-2 px-4 rounded-lg transition-colors text-sm font-medium flex items-center justify-center ${isFollowing
                      ? "bg-gray-100 hover:bg-gray-200 text-newBlack"
                      : "bg-newYellow hover:bg-amber-200 text-newBlack"
                      }`}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 mt-5">
        <div className="bg-white rounded-full shadow-sm border border-gray-100 p-1.5 flex items-center overflow-x-auto scrollbar-hide">
          ...
          {/* <button
            ...
            className={`flex items-center justify-center gap-2 py-2.5 px-4 rounded-full transition-all ${activeTab === "orders"
              ? "bg-newBlack text-white font-medium"
              : "text-gray-600 hover:bg-gray-100"
              }`}
          >
...
export default UserSideSellerProfile;
