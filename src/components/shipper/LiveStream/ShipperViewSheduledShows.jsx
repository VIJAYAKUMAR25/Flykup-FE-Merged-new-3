...
const ShipperViewScheduledShows = () => {
  ...
  const handleEditProductsTagged = (showId) => {
    navigate('/shipper/edit-tagged-products', { state: showId});
  }

  const handleOpenShow = (showId) => {
    navigate(`/shipper/show/${showId}`);
  };
  ...
  return (
    ...
    <div className="sticky top-0 z-10 bg-white p-4 shadow-sm">
      <div className="flex justify-between items-center mb-4">
        ...
        <button
          onClick={() => navigate("/shipper/sheduleshow")}
...
export default ShipperViewScheduledShows;